...
*
*	@param SM_FileHandle :  Pointer that holds the information of the file that is being pointed
*	@author Praveen
*	@return RC value(defined in dberrror.h)
*/
...
*		   file name, total number of pages and management info)
*    	@author Dhayalini
*    	@return RC value(defined in dberrror.h)
*/
...
/*    readFirstBlock method
*    To read the  first block of the file
*
*	@param   fileHandle(consists of current page position,
*		 file name, total number of pages and  management info),
* 	@param   pageHandle(is a pointer to an area in memory storing the data of a page)
*    @author Dhayalini
*    @return RC value(defined in dberrror.h)
*/
